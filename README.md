...
1. Add this repo (https://github.com/AmarokTv/ha-edilkamin) as custom repo ([HACS how-to](https://hacs.xyz/docs/faq/custom_repositories))
...
- This project includes the code from [edilkamin.py](https://github.com/AndreMiras/edilkamin.py) (MIT licence) - originally by @AndreMiras. The source code is now integrated directly in the `external_edilkamin` package to eliminate external PyPI dependency.
